...
from atk_conformer_generation.variables import *
import pandas as pd
...
def step3_optimize_conformers(
    ...
    sorted_output_sdf = "sorted_" + opt_conf_sdf  
    sort_conformers_by_energy(opt_conf_sdf, sorted_output_sdf) 
...
@app.command()
def main(ref_confo_path: str ,inp_smiles: str,num_conf: int = 1000,num_clusters: int=20) -> None:
    """
